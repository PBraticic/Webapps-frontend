<template>
  <div class="pozadina">
    <p
      style="font-size: 200px; text-align: center; font-family: 'Brush Script MT'; color: #6428bd; text-shadow: -4px 0 black, 0 10px black, 4px 0 black, 0 -4px black;">
      SitCo</p>
    ...
    <div class="form-box">
      ...
      <form v-if="isLogin" class="input-group" @submit.prevent="login">
        ...
        <input type="password" class="input-field fs-5 fw-bold" placeholder="Enter Password" v-model="loginPassword"
          required>
      ...
      <form v-else class="input-group" @submit.prevent="register">
        ...
        <input type="password" class="input-field fs-5 fw-bold" placeholder="Enter Password" v-model="registerPassword"
          required>
        <div>
